(function ($) {
  ...
  function GanttColumn(options) {
    ...
    var _defaults = {
      ...
      cssClass: 'gantt-cell',
      toolTip: 'Gantt',
      handleSelectedRowsChanged: false,
      width: 300
    };
    ...
    function init(grid) {
      ...
      _grid = grid;
      if (options.enableForCells) _grid.onSelectedRowsChanged.subscribe(handleSelectedRowsChanged);
      if (options.enableForHeaderCells) _grid.onClick.subscribe(handleClick);
      if (options.enableForHeaderCells) _grid.onHeaderClick.subscribe(handleHeaderClick);
    }
